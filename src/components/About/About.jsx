...
const About = () => {
  return (
    <section className="w-full bg-[#c5f1fc] py-16 px-6 md:px-12 lg:px-16 overflow-hidden">
      <div className="max-w-[1440px] mx-auto rounded-[2rem] md:rounded-[3rem] bg-[#c5f1fc] text-white">
